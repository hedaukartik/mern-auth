...
const sendActivationEmailData = require("../config/emails/sendActivationEmail");
const sendResetPasswordEmailData = require("../config/emails/sendResetPasswordEmail");
const generatedToken = require("../config/tokenGenerator");
...
exports.forgotPasswordController = (req, res) => {
	...
	User.findOne(
		...
		(err, user) => {
			...
			const emailData = sendResetPasswordEmailData(email, token);
